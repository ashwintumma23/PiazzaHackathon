!function(){
	var bP={};	
	var b=30, bb=500, height=1200, buffMargin=1, minHeight=14;
	var c1=[-250, 100], c2=[150, 200], c3=[-80, 190]; //Column positions of labels.
	var colors =["#3366CC", "#DC3912",  "#FF9900","#109618", "#990099", "#0099C6","#EFEF11","#C6B3F0","#B6F0B3","#EA8193","#72E8EA","#F5B46F","#C0CA33","#E0E0E0"]
	...
	function drawHeader(header, id){
		d3.select("#"+id).append("g").attr("class","header").append("text").text(header[2])
			.style("font-size","20").attr("x",300).attr("y",-20).style("text-anchor","middle")
